...
BEGIN
    ...
    -- Записываем в историю списания
    INSERT INTO lesson_deductions (
        student_id,
        lessons_deducted,
        reason,
        deducted_at
        ...
        p_student_id,
        p_lessons_count,
        COALESCE(p_reason, 'Списание уроков'),
        NOW()
    );
...
-- 7. Функция добавления уроков (исправлена колонка lessons_purchased)
...
BEGIN
    ...
    -- Записываем платеж (используем правильное имя колонки)
